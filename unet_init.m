function net = unet_init()
    ...
    net.addLayer('conv3x3_03', convBlock(3,3,64,128), {'x03'}, {'x04'}, {'f03', 'b03'});
    ...
    %net.addLayer('pool_20', dagnn.Unpooling(), {'x20'}, {'x21'}, {});
    ...
    %net.addLayer('upconv_25', dagnn.Unpooling(), {'x25'}, {'x26'}, {});
    
    %net.addLayer('crop_26', dagnn.Crop(), {'x20', 'x26'}, {'x27'}, {});
    %net.addLayer('concat_27', dagnn.Concat('dim', 3), {'x27', 'x26'}, {'x28'}, {});
    %net.addLayer('conv3x3_28', convBlock(5,5,,512), {'x26'}, {'x29'}, {'f28', 'b28'});
    ...
    %net.addLayer('upconv_32', dagnn.Unpooling(), {'x32'}, {'x33'}, {});
    
    %net.addLayer('crop_33', dagnn.Crop(), {'x15', 'x33'}, {'x34'}, {});
    %net.addLayer('concat_34', dagnn.Concat('dim', 3), {'x34', 'x33'}, {'x35'}, {});
    %net.addLayer('conv3x3_35', convBlock(5,5,512,256), {'x21'}, {'x36'}, {'f35', 'b35'});
    ...
    %net.addLayer('upconv_39', dagnn.Unpooling(), {'x39'}, {'x40'}, {});
    
    %net.addLayer('crop_40', dagnn.Crop(), {'x10', 'x40'}, {'x41'}, {});
    %net.addLayer('concat_41', dagnn.Concat('dim', 3), {'x41', 'x40'}, {'x42'}, {});
    %net.addLayer('conv3x3_42', convBlock(5,5,256,128), {'x40'}, {'x43'}, {'f42', 'b42'});
    ...
    %net.addLayer('upconv_46', dagnn.Unpooling(), {'x46'}, {'x47'}, {});
    ...
    %Visualize Network
    net.print({'input', [264 264 1]}, 'all', true, 'format', 'dot')
